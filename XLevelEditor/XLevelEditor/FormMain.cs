...
namespace XLevelEditor
{
    public partial class FormMain : Form
    {
        ...
        public GraphicsDevice GraphicsDevice
        {
            get
            {
                return mapDisplay.GraphicsDevice;
            }
        }
        ...
        #region Form Even Handler region
        ...
        private void FillPreviews()
        {
            ...
            GDIRectangle dest = new GDIRectangle(0, 0, preview.Width, pbTilePreview.Height);
        ...
        #region Save Menu Event Handler region
        ...
        void saveLevelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                string MapPath = Path.Combine(fbDialog.SelectedPath, @"Maps\");
        ...
        void openLevelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(exc.Message, "Error loading level");
                return;
            }
        ...
        void openLayerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(exc.Message, "Error opening map layer");
                return;
            }
            ...
            for (int i = 0; i < clbLayers.Items.Count; i++)
            {
                ...
                {
                    MessageBox.Show("Layer with that name already exists.", "Existing layer");
                    return;
                }
            }
        ...
        void openTilesetToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(exc.Message, "Error opening tileset");
                return;
            }
        ...
        void mapDisplay_OnInitialize(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(exc.Message, "Error reading file");
                grid = null;
                cursor = null;
            }
        }
