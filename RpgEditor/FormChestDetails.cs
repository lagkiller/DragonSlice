...
namespace RpgEditor
{
    public partial class FormChestDetails : Form
    {
        ...
        public FormChestDetails()
        {
            ...
            cbLock.CheckStateChanged += new EventHandler(cbLock_CheckStateChanged);
            cbTrap.CheckStateChanged += new EventHandler(cbTrap_CheckStateChanged);
        ...
        #region Checkbox Event Handler region

        void cbTrap_CheckStateChanged(object sender, EventArgs e)
        {
            tbTrap.Enabled = cbTrap.Checked;
        }

        void cbLock_CheckStateChanged(object sender, EventArgs e)
        {
